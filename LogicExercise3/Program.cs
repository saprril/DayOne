...
namespace LogicExercise3
{
    class Program
    {
        ...
        */
        public static readonly string[] labels = { "foo", "baz", "bar", "jazz", "huzz" }; // Number divisor label
        ...
        public enum Divisibility : byte
        {
            ...
            */
            None = 0, //00000
            DivisibleBy3 = 1 << 0, //00001
            DivisibleBy4 = 1 << 1, //00010
            DivisibleBy5 = 1 << 2, //00100
            DivisibleBy7 = 1 << 3, //01000
            DivisibleBy9 = 1 << 4 //10000
        }
        ...
        public static Divisibility ModuloProcessor(int value)
        {
            ...
            */
            ...
            if (value % 3 == 0)
            {
                ...
                if (value % 9 == 0)
                {
                    evaluation |= Divisibility.DivisibleBy9;
                }
            }
            if (value % 4 == 0)
            {
                evaluation |= Divisibility.DivisibleBy4;
            }
            if (value % 5 == 0)
            {
